...
sudo apt-get -y install autoconf automake autotools-dev curl ninja-build git 
sudo apt-get -y install bison flex texinfo gperf libtool patchutils bc zlib1g-dev
sudo apt-get -y install libmpc-dev libmpfr-dev libgmp-dev libexpat-dev libglib2.0-dev libslirp-dev libexpat-dev 
# --------------------------------------------------
